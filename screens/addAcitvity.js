...
class addAcitvity extends Component {
  constructor(props) {
    super(props);
    this.dbRef = firebase.firestore().collection('directManPower');
    this.state = {
      Project:'',
...
goBack = () => this.props.navigation.navigate('DirectManPower')
