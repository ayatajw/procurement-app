...
class AcitvityDetails extends Component {
  ...
  updateDirectMP(theProject=this.state.Project,theUser=this.state.User,theDate=this.state.Date,theStatus=this.state.Status) {
    this.setState({
      isLoading: true,
    });
    const updateDBRef = firebase.firestore().collection('directManPower').doc(this.state.key);
    updateDBRef.set({
...
<View style={styles.headermain} >
        <View style={styles.header} >
                ...
                <Text style={styles.gobackbtn} onPress={() => this.props.navigation.navigate('DirectManPower')}>Go Back</Text>                    
                </View>
          </View>
        ...
        <View style={styles.welcomebar}>
            <Text style={styles.welcomebartitle}> Direct Manpower </Text>
