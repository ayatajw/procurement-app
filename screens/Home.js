          ...
          dbRefUser.get().then((res) => {
            if (res.exists) {
              ...
              this.setState({
                ...
                isLoading: false
              }); if (userDetails.role === "1"){ this.props.navigation.navigate('Dashboard') };
...
CheckOutRange=()=>{
 ...
 CheckInBTN = () => {
  ...
  render() {
            ...
            const { navigation } = this.props;
            var bb = '../assets/'+this.state.ProjImage;

        console.log(bb);

            var icon = this.state.ProjImage ? require('../assets/p-01.png') : require('../assets/101.jpg');
                    ...
                    <View style={styles.viewAll}>
                      ...
                      <View style={styles.multiPojBox}>
                          ...
                          <TouchableOpacity style={styles.projimagefull} onPress={() => this.props.navigation.navigate('ProjectDetails', { JSON_ListView_Clicked_Item: this.state.projectID, JSON_projectname: this.state.ProjectName })} >
                               ...
                               <Image style={styles.activeprojPic} source={icon} />
